...
exports.updateVendor = async (req, res) => {
  try {
    ...
    // Handle depId from frontend -> vendor_belongs_to in schema
    if (updatedData.depId !== undefined) {
      updatedData.vendor_belongs_to = updatedData.depId;
      delete updatedData.depId;
    }
